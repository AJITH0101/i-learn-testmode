...
const TextToSpeech = () => {
    const [text, setText] = useState("Hi Ajith! how can i assist you in improving your english today? Would you like to talk about a specific topic. or practice something together?");
